...
/*   Updated: 2023/11/08 18:37:34 by vnieto-j         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pthread_mutex_lock(&philospher->fork_left);
	...
	pthread_mutex_unlock(&philospher->pa->write_mutex);
	ft_usleep(philospher->pa->time_to_eat);
	pthread_mutex_unlock(philospher->fork_right);
	pthread_mutex_unlock(&philospher->fork_left);
